...
public class DialogoPaddle extends JDialog implements ActionListener{

	public JLabel l1,l2,l3,l4,l5,l6,l7;
	public JTextField t1,t2,t3,t4,t5,t6,t7;
	public JButton b1,b2;
	public CPaddle campo;
	
	public DialogoPaddle(Finestra f,boolean modal) {
		super(f,modal);
		initC();
	...
	private void initC() {
		...
		l7=new JLabel("Inserire numero di partecipanti");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource().equals(b1)) {
			campo=new CPaddle(new Socio(t3.getText(),t4.getText(),t5.getText(),t6.getText()),Integer.parseInt(t1.getText()),Integer.parseInt(t2.getText()),Integer.parseInt(t7.getText()));
			dispose();
		}
		
	}
	
	public Campo ritornaCampoPaddle() {
		return campo;
	}
}
